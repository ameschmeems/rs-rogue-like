...
impl State {
	...
	fn game_over(&mut self, ctx: &mut BTerm) {
		...
		ctx.print_color_centered(2, RED, BLACK, "Your quest is over");
		ctx.print_color_centered(4, WHITE, BLACK, "Slain by a monster, your journey has come to an end");
		ctx.print_color_centered(8, YELLOW, BLACK, "You can always try again");
		ctx.print_color_centered(9, GREEN, BLACK, "Press 1 to retry");
	...
	fn victory(&mut self, ctx: &mut BTerm) {
		...
		ctx.print_color_centered(4, WHITE, BLACK, "You put on the amulet and feel its power");
